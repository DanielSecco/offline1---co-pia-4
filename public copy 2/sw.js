...
//importScripts('/src/js/index.js');
//mportScripts('../src/index.js');
...
self.addEventListener('push', function(event) {
  ...
  console.log(`[Service Worker] Push had this data: "${event.data.text()}"`);
    newdataPush = {
                    type: 'success',
                    title: `[Service Worker] Push had this data: "${event.data.text()}"`,
                    message: 'servicePush'
                };
    writeData('notificationsP', newdataPush);
    //dataPush.push(newdataPush);
  /*  for (var key in dataPush) {
                
              writeData('notificationsP', dataPush[key])
            }*/
